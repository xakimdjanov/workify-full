...
export default function JobDetail() {
    ...
    if (loading)
        return (
            ...
            >
                <div
                    className={`w-10 h-10 border-4 rounded-full animate-spin ${isDark
    ...
    return (
        ...
        >
            <div className="max-w-4xl mx-auto">
                <button
                    onClick={() => navigate(-1)}
                    className={`flex items-center gap-2 font-bold mb-6 transition-colors ${isDark
                ...
                <div
                    className={`rounded-[32px] p-8 border transition-all duration-500 mb-6 shadow-sm ${isDark ? "bg-[#1E1E1E] border-gray-800" : "bg-white border-gray-100"
                        }`}
                >
                ...
                <div
                    className={`rounded-[32px] p-8 md:p-10 border transition-all duration-500 shadow-sm ${isDark ? "bg-[#1E1E1E] border-gray-800" : "bg-white border-gray-100"
                        }`}
                >
                    <div
                        className={`relative border-2 border-dashed rounded-[28px] p-12 text-center transition-all ${isDark
                    ...
                    {selectedFile && (
                        <div
                            className={`flex items-center justify-between p-4 rounded-2xl mt-6 border ${isDark
                    ...
                    <textarea
                        className={`w-full mt-8 p-6 border-none rounded-[24px] outline-none min-h-[150px] transition-all ${isDark
                    ...
                    <div className="flex items-center justify-between mt-8">
                        ...
                        <button
                            ...
                            className={`px-16 md:px-24 py-4 rounded-2xl text-white font-black text-lg shadow-lg transition-all ${isSubmitting
