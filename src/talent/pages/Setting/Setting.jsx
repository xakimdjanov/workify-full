...
const Setting = () => {
  ...
  return (
    <div
      className={`min-h-full p-4 sm:p-6 md:p-8 pb-[100px] md:pb-8 font-sans transition-colors duration-500 ${settings.darkMode
    ...
    >
      <div className="max-w-[900px] mx-auto relative">
        ...
        >
          <h1
            className={`text-xl md:text-2xl font-semibold ${settings.darkMode ? "text-gray-200" : "text-{#505151}"
              } ml-1`}
          >
            Settings
          </h1>
        ...
        <div className="mb-8">
          ...
          >
            ...
            <div
              className={`px-4 py-2 rounded-lg text-sm font-semibold ${settings.darkMode
        ...
        {showLogoutModal && (
          <div className="fixed inset-0 z-[999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div
              className={`${settings.darkMode ? "bg-[#1E1E1E] border-gray-700" : "bg-white"
            ...
            >
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className={`flex-1 py-3 rounded-xl font-semibold transition-colors ${settings.darkMode
...
const SettingItem = ({
  ...
  <div
    className={`${isDark ? "bg-[#1E1E1E] border-gray-800" : "bg-white border-gray-50"
