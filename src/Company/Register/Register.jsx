...
const SignUpPage = () => {
  ...
  // Dropdown yo'nalishini aniqlash uchun statelar
  ...
  const checkSpace = (ref, setDropUp) => {
    if (ref.current) {
      ...
      // Agar pastda 300px dan kam joy bo'lsa, tepaga ochiladi
      if (spaceBelow < 300) {
        setDropUp(true);
      } else {
        setDropUp(false);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 sm:gap-y-6">
              ...
              <div className="relative space-y-1" ref={countryRef}>
                ...
                <div
                  className="relative cursor-pointer"
                  onClick={() => {
                    checkSpace(countryRef, setDropUpCountry);
                ...
                {showCountryDropdown && (
                  <div className={`absolute z-50 w-full bg-white border border-gray-100 rounded-xl shadow-xl max-h-52 overflow-y-auto ${dropUpCountry ? "bottom-full mb-1" : "mt-1"}`}>
                    <div className="sticky top-0 bg-white p-2 border-b border-gray-100">
                      <input
                        className="w-full px-4 py-1.5 bg-gray-50 rounded-lg outline-none text-sm"
                        placeholder="Search..."
              ...
              <div className="relative space-y-1" ref={industryRef}>
                ...
                <div
                  className="relative cursor-pointer"
                  onClick={() => {
                    checkSpace(industryRef, setDropUpIndustry);
                ...
                {showIndustryDropdown && (
                  <div className={`absolute z-50 w-full bg-white border border-gray-100 rounded-xl shadow-xl max-h-52 overflow-y-auto ${dropUpIndustry ? "bottom-full mb-1" : "mt-1"}`}>
                    <div className="sticky top-0 bg-white p-2 border-b border-gray-100">
                      <input
                        className="w-full px-4 py-1.5 bg-gray-50 rounded-lg outline-none text-sm"
                        placeholder="Search..."
                  ...
                  {formData.country === "Uzbekistan" ? (
                    <>
                      <input
                        ...
                        value={formData.city}
                        onClick={() => {
                          checkSpace(cityRef, setDropUpCity);
                      ...
                      <FaChevronDown className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-300 text-xs" />
                      {showCityDropdown && (
                        <div className={`absolute z-50 w-full bg-white border border-gray-100 rounded-xl shadow-xl max-h-52 overflow-y-auto ${dropUpCity ? "bottom-full mb-1" : "mt-1"}`}>
                          <div className="sticky top-0 bg-white p-2 border-b border-gray-100">
                            <input
                              className="w-full px-4 py-1.5 bg-gray-50 rounded-lg outline-none text-sm"
                              placeholder="Search city..."
